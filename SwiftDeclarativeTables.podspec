...
Pod::Spec.new do |s|
  ...
  s.author             = { "Paige Sun" => "paige.sun.dev@gmail.com" }
  # Or just: s.author    = "Paige Sun"
  # s.authors            = { "Paige Sun" => "paige.sun.dev@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Paige Sun"
