...
private extension UIView {
	func addDiagonalShading(size: CGRect, index: Int) {
		struct GradientColors {
			private static let topColors = [#colorLiteral(red: 0.4, green: 0.3490196078, blue: 0.007843137255, alpha: 1), #colorLiteral(red: 0.4, green: 0.007843137255, blue: 0.3490196078, alpha: 1), #colorLiteral(red: 0.4, green: 0.007843137255, blue: 0.007843137255, alpha: 1), #colorLiteral(red: 0.05490196078, green: 0.4, blue: 0.007843137255, alpha: 1), #colorLiteral(red: 0.5882352941, green: 0.3607843137, blue: 0, alpha: 1), #colorLiteral(red: 0.007843137255, green: 0.07058823529, blue: 0.4, alpha: 1), #colorLiteral(red: 0.4, green: 0, blue: 0.3504559801, alpha: 1), #colorLiteral(red: 0.4, green: 0.2038615125, blue: 0, alpha: 1), #colorLiteral(red: 0.2074886848, green: 0, blue: 0.4, alpha: 1)]
